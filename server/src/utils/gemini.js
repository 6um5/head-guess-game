...
const TRIBUTE_PROFILES = {
  ميسمالبرونزيه: {
    ...
    context: 'ميسم فتاة ببشرة برونزية دافئة، لها حضور هادئ وثقة وأناقة.',
    extra:
      '- لازم تغزلين بلونها البرونزي بلمسة راقية وخفيفة في كل نص، بدون ابتذال ولا تكرار نفس الوصف.',
    fallbacks: [
      'ميسم، لونج البرونزي مو صدفة… هذا غروب كامل قرر يسكن بوجه وحدة.',
      'يا ميسم، البرونزي عليج مو لون بشرة؛ هذا دفو شمس تعرف وين تنام.',
      'ميسم، من تمرين، الذهب يحس روحه ناقص شوية سمرة مثل سمرتج.',
      'والله يا ميسم، سمرتج البرونزية تخلي الضوء يتعلم شلون يوگع صح.',
      'ميسم البرونزية، انتِ الوحيدة اللي الصيف يحسدها على لونها.',
      'يا ميسم، شمس بغداد كلها ما نطت هالحلو… انتِ اللي نطيتيه للشمس.',
      'ميسم، حبج مثل النحاس القديم: بسيط بالنظرة، وثمين لمن يعرفه.',
      'من عيونج يا ميسم، ومن لونج البرونزي، صار عندي وقت مفضل بالنهار.',
      'ميسم، لو الجمال ينقاس بلون، جان البرونزي أخذ الدرجة الأولى بسببج.',
      'يا ميسم، انتِ مو حلوة بس… انتِ دفو يجي بلا موعد وما يروح.',
    ],
    images:
      'لون برونزي، غروب، شمس دافئة، نحاس قديم، ذهب، صيف، ضوء مائل، ظل خفيف، هدوء وثقة',
  },
  طوطه: {
    name: 'طوطه',
    fallbacks: [
