            ...
            <div className="space-y-4 text-sm leading-relaxed text-slate-300">
              ...
              <section className="rounded-2xl border border-white/10 bg-white/5 p-4">
                ...
                <ul className="list-disc space-y-1 pr-5">
                  ...
                  <li>
                    الإجابة ذكية: «مروه» تساوي «مروة»، و«احمد» تساوي «أحمد»،
                    ولا يهم التشكيل ولا «ال» التعريف ولا المسافات.
                  </li>
                </ul>
              </section>
              ...
              <section className="rounded-2xl border border-white/10 bg-white/5 p-4">
                ...
                <ul className="list-disc space-y-1 pr-5">
                  <li>
                    الذكاء الاصطناعي يختار كلمات سهلة ومشهورة يعرفها الجميع،
                    ولا يكرر أي كلمة استُعملت في نفس الغرفة.
                  </li>
                  ...
                  <li>
                    يوجد أيضاً تلميح ذكاء اصطناعي، وكل طلب جديد يكشف أكثر:
                    عدد الحروف، ثم أول حرف، ثم أول وآخر حرف.
                  </li>
